...
截至目前，Fei-Away/Codex-Dream-Skin 在 GitHub 上已超过 1 万个 star，仓库也保持着更新记录。对读者来说，更值得关注的不是热度本身，而是它把换肤这件小事拆成了安装、启动、验证和回滚四个可检查步骤。
...
下面的流程按项目 Windows 文档和运行时说明整理。为了不替读者改动本机 Codex，这里不把它包装成已在所有设备上实测成功的经历；你真正操作时，以仓库当前 README 和脚本为准。
