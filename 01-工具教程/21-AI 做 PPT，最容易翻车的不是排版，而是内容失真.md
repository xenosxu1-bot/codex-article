> 一句话结论：AI 能帮你快速摆脱空白页，却不能替你确认：这份内容能不能在会上讲、经不经得起追问、会不会误导决策。
...
AI 做 PPT 最容易错的不是字体，而是把不确定内容做得很确定。每次交付前至少检查五项。

第一，标题有没有夸大结论。第二，图表数字有没有来源和口径。第三，案例是不是来自真实材料，还是 AI 顺手编出来的。第四，每页只表达一个核心观点，还是把多个结论挤在一起。第五，听众看完这一页后，下一步动作是否明确。

一个简单办法是让 AI 在每页备注里补一句“本页依据是什么”。如果它说不清依据，这页就不能直接拿去汇报。
