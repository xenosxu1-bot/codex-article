...
用途：把 07-资料与流程/02-选题与发布/选题库.md 中的选题ID，和
07-资料与流程/03-资产与核验/文章资产登记表.md 中已经生成的正文文件建立绑定，
用于查重、排期和避免重复生成同主题文章。
"""
...
TOPIC_FILE = ROOT / "07-资料与流程" / "02-选题与发布" / "选题库.md"
ASSET_FILE = ROOT / "07-资料与流程" / "03-资产与核验" / "文章资产登记表.md"
OUTPUT_FILE = ROOT / "07-资料与流程" / "04-索引与报告" / "选题文章绑定表.md"
