...
function usage() {
  return [
    '用法：node 09-工具脚本/02-内容去重与归档/批量归档微信公众号原创.mjs --manifest 文章清单.json --captured-at YYYY-MM-DD [--rights account-owner-authorized] [--delay-ms 800] [--report 同步记录.json] [--dry-run]',
