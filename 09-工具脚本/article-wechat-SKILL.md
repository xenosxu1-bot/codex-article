...
当用户要求生成、优化或批量制作文章封面时，先读取 `references/visual-policy.md` 和 `references/templates/cover-prompt-template.md`。默认采用 V1.1 统一封面系统：2.35:1 横版、2350 × 1000 px、左文右图、明确主副标题、主题驱动的动态配色与原创右侧视觉主体。
