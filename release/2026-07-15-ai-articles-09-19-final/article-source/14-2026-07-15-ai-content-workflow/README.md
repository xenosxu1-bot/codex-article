---
title: "用 AI 做内容，不是让它替你写：一套“选题—资料—初稿—事实核查—改写”工作流"
...
# 用 AI 做内容，不是让它替你写：一套“选题—资料—初稿—事实核查—改写”工作流
...
更稳妥的原则是：**人决定写什么、为什么写、愿意为什么负责；AI 处理可以被结构化的劳动。**
...
> 目标读者正在 ______，因为 ______；这篇文章能让他下一步 ______。
