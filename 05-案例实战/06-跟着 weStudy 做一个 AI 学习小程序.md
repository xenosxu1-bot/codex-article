> 一句话结论：这篇不拆代码细节。重点讲我怎样把一个想做 AI 学习小程序的想法，借助 WorkBuddy、Codex 和微信开发者工具，一步步推到 `D:\projects_git\weStudy` 当前这个可联调、可真机预览、可准备提审的状态。
...
## 二、第一步：需求调研不要问做什么功能，先问谁在哪个时刻会打开
...
## 三、第二步：让 WorkBuddy 产出 PRD，但一定要带砍功能清单
...
## 四、第三步：把文档交给 Codex，不是让它开始写，而是先让它读懂当前项目
...
## 八、第七步：免费云服务和 AI 模型可以用，但要从第一天开始记录成本边界
...
## 九、第八步：测试不是点一点页面，而是验证孩子真的能完成一次学习
