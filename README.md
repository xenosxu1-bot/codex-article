# 微信公众号 Codex 教程交付包
本仓库整理了 6 篇公众号风格 Codex 中文教程稿，配套中文标注界面图、官方工具图片和流程图，适合用于公众号、知识库、社群教程或 GitHub 项目说明。
...
## 图片素材
图片位于 `images/`，包含中文标注图、公众号封面式配图和第 6 篇使用的官方工具图片：
...
## 使用建议
发布到公众号时，可将 Markdown 内容复制到编辑器，再按图片引用位置插入对应图片。第 6 篇使用官方工具图片与 Mermaid 流程图，发布到不支持 Mermaid 的平台时，可先截图再插入。
